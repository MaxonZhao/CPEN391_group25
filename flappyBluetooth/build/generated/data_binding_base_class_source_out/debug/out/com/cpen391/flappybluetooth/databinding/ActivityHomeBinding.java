...
public final class ActivityHomeBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView btnPress;
  ...
  private ActivityHomeBinding(@NonNull LinearLayout rootView, @NonNull TextView availableDevicesTxt,
      ...
      @NonNull Button btnFindUnpairedDevices, @NonNull Button btnONOFF, @NonNull ImageView btnPress,
      @NonNull Button btnSend, @NonNull Button btnStartConnection, @NonNull EditText editText,
  ...
  public static ActivityHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.btnPress;
      ImageView btnPress = rootView.findViewById(id);
      if (btnPress == null) {
        break missingId;
      }
      ...
      return new ActivityHomeBinding((LinearLayout) rootView, availableDevicesTxt, bluetoothIcon,
          btnDiscoverableOnOff, btnFindUnpairedDevices, btnONOFF, btnPress, btnSend,
          btnStartConnection, editText, lvNewDevices, pairedDevicesTxt, pairedDevicesView);
    }

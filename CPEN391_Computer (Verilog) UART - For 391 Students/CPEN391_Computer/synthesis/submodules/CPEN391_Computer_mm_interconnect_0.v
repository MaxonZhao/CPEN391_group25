...
module CPEN391_Computer_mm_interconnect_0 (
	...
	wire          renderer_0_slave_agent_rp_valid;                                                               // renderer_0_slave_agent:rp_valid -> router_018:sink_valid
	wire  [130:0] renderer_0_slave_agent_rp_data;                                                                // renderer_0_slave_agent:rp_data -> router_018:sink_data
	wire          renderer_0_slave_agent_rp_ready;                                                               // router_018:sink_ready -> renderer_0_slave_agent:rp_ready
	wire          renderer_0_slave_agent_rp_startofpacket;                                                       // renderer_0_slave_agent:rp_startofpacket -> router_018:sink_startofpacket
	wire          renderer_0_slave_agent_rp_endofpacket;                                                         // renderer_0_slave_agent:rp_endofpacket -> router_018:sink_endofpacket
	...
	wire          cmd_mux_013_src_valid;                                                                         // cmd_mux_013:src_valid -> renderer_0_slave_burst_adapter:sink0_valid
	wire  [130:0] cmd_mux_013_src_data;                                                                          // cmd_mux_013:src_data -> renderer_0_slave_burst_adapter:sink0_data
	wire          cmd_mux_013_src_ready;                                                                         // renderer_0_slave_burst_adapter:sink0_ready -> cmd_mux_013:src_ready
	wire   [15:0] cmd_mux_013_src_channel;                                                                       // cmd_mux_013:src_channel -> renderer_0_slave_burst_adapter:sink0_channel
	wire          cmd_mux_013_src_startofpacket;                                                                 // cmd_mux_013:src_startofpacket -> renderer_0_slave_burst_adapter:sink0_startofpacket
	wire          cmd_mux_013_src_endofpacket;                                                                   // cmd_mux_013:src_endofpacket -> renderer_0_slave_burst_adapter:sink0_endofpacket
	...
	wire   [15:0] renderer_0_slave_burst_adapter_source0_channel;                                                // renderer_0_slave_burst_adapter:source0_channel -> renderer_0_slave_agent:cp_channel
	...
	wire          renderer_0_slave_agent_rdata_fifo_out_valid;                                                   // renderer_0_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter_013:in_0_valid
	wire   [33:0] renderer_0_slave_agent_rdata_fifo_out_data;                                                    // renderer_0_slave_agent_rdata_fifo:out_data -> avalon_st_adapter_013:in_0_data
	wire          renderer_0_slave_agent_rdata_fifo_out_ready;                                                   // avalon_st_adapter_013:in_0_ready -> renderer_0_slave_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_013_out_0_valid;                                                             // avalon_st_adapter_013:out_0_valid -> renderer_0_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_013_out_0_data;                                                              // avalon_st_adapter_013:out_0_data -> renderer_0_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_013_out_0_ready;                                                             // renderer_0_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_013:out_0_ready
	wire    [0:0] avalon_st_adapter_013_out_0_error;                                                             // avalon_st_adapter_013:out_0_error -> renderer_0_slave_agent:rdata_fifo_sink_error

...
namespace Patrick {
	Bird::Bird(GameDataRef data) : _data(data) {
		...
		_animationFrames.push_back(_data->assets.GetTexture("Bird_Frame_1"));
		_animationFrames.push_back(_data->assets.GetTexture("Bird_Frame_2"));
		_animationFrames.push_back(_data->assets.GetTexture("Bird_Frame_3"));
		_animationFrames.push_back(_data->assets.GetTexture("Bird_Frame_4"));
